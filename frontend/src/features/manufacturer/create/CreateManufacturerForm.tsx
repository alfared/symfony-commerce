...
type Props = {
    onSubmit: (payload: CreateManufacturerPayload) => void;
};

export function CreateManufacturerForm({ onSubmit }: Props) {
    ...
    return (
        <form onSubmit={submit} className="grid gap-3 rounded-2xl border border-slate-800 bg-slate-900 p-5">
            <h2 className="text-x1 font-semibold text-slate-50">Create Manufacturer</h2>
